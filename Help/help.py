...
SCREEN = os.path.join(PATH, "screenshots")
ICONS = os.path.join(PATH, "icons")
TEXTS = os.path.join(PATH, "texts")
VERSION = "V0.00.04"
...
class App(ctk.CTk):
	...
	def __init__(self):
		...
		self.overview_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "overview_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "overview_dark.png")), size=(20, 20))
		self.gettingSt_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "gettingSt_light.png")),
											dark_image=Image.open(os.path.join(image_path, "gettingSt_dark.png")), size=(20, 20))
		self.import_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "import_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "import_dark.png")), size=(20, 20))
		self.dataA_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "data_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "data_dark.png")), size=(20, 20))
		self.changeover_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "changeover_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "changeover_dark.png")), size=(20, 20))
		self.search_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "search_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "search_dark.png")), size=(20, 20))
		self.custom_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "custom_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "custom_dark.png")), size=(20, 20))
		self.output_img = ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "output_light.png")),
											 dark_image=Image.open(os.path.join(image_path, "output_dark.png")), size=(20, 20))
